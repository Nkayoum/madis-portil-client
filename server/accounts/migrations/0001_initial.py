    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('CLIENT', 'Client'), ('ADMIN_MADIS', 'Administrateur MaDis'), ('CHEF_CHANTIER', 'Chef de chantier')], default='CLIENT', max_length=20, verbose_name='rôle')),
