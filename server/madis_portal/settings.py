"""
Django settings for madis_portal project.
Portail Clients MADIS — MVP v0.1.0
"""
...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1,192.168.31.85', cast=Csv())
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='madis_portal_bd'),
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Portail Clients MADIS API',
    'DESCRIPTION': 'API REST du portail clients MADIS — MVP v0.1.0',
    'VERSION': '0.1.0',
...
if DEBUG:
    default_cors = 'http://localhost:3000,http://127.0.0.1:3000,http://localhost:5173,http://127.0.0.1:5173,http://localhost:5174,http://localhost:5175,http://192.168.31.85:5173'
else:
