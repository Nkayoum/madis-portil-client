    ...
    return (
        <div className="max-w-[1600px] mx-auto space-y-10 animate-fade-in pb-20 px-4 md:px-10">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 md:gap-8">
                <div>
                    <h1 className="text-xl md:text-2xl font-bold tracking-tight uppercase leading-tight md:leading-none mb-1.5 md:mb-2">Messagerie</h1>
                    <p className="text-[9px] md:text-[10px] font-semibold uppercase tracking-wider opacity-60">Gestion et suivi des protocoles de communication assistée.</p>
                </div>
                <Link
            ...
            <div className="solaris-glass rounded-[1.25rem] md:rounded-[2rem] p-4 md:p-6 border-none shadow-sm space-y-4 md:space-y-6">
                ...
                <div className="flex flex-wrap items-center gap-3 md:gap-4 lg:gap-6">
                    ...
                    <div className="flex items-center gap-2 flex-grow min-w-[200px]">
                        <label className="text-[8px] font-bold uppercase tracking-widest opacity-40 shrink-0">Recherche</label>
                        <input
                            type="text"
                            placeholder="Sujet..."
                            value={search}
                    ...
                    <div className="flex items-center gap-2 min-w-[140px]">
                        <label className="text-[8px] font-bold uppercase tracking-widest opacity-40 shrink-0">État</label>
                        <select
                            name="status"
                    ...
                    {/* Priority Select */}
                    <div className="flex items-center gap-2 min-w-[140px]">
                        <label className="text-[8px] font-bold uppercase tracking-widest opacity-40 shrink-0">Priorité</label>
                        <select
                            name="priority"
                    ...
                    <div className="flex items-center gap-2 min-w-[180px]">
                        <label className="text-[8px] font-bold uppercase tracking-widest opacity-40 shrink-0">Bien</label>
                        <select
                            name="property"
                            ...
                            >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <div className="flex flex-wrap items-center gap-4">
                                            <div className="flex items-center gap-1.5 bg-black/[0.03] dark:bg-white/5 px-2 py-1 rounded-lg border border-black/5 dark:border-white/5">
                                                <span className="text-[8px] font-bold uppercase tracking-widest opacity-30">ID</span>
                                ...
                                <div className="flex items-center justify-end">
                                    <div className="flex items-center gap-2 text-black dark:text-white lg:opacity-0 lg:group-hover:opacity-100 transition-all duration-500 lg:group-hover:translate-x-1">
                                        <span className="text-[9px] font-bold uppercase tracking-widest">Détails</span>
