    ...
    return (
        <div className="max-w-5xl mx-auto pb-12 animate-fade-in space-y-8">
            ...
            <div className="bg-card border border-border/50 rounded-3xl shadow-2xl overflow-hidden backdrop-blur-sm relative">
                ...
                {/* Tab Navigation */}
                <div style={{ overflowX: 'auto', WebkitOverflowScrolling: 'touch', scrollbarWidth: 'none', msOverflowStyle: 'none' }} className="flex justify-center border-b border-border/50 bg-muted/20 [&::-webkit-scrollbar]:hidden">
                    {TABS.map((tab) => {
