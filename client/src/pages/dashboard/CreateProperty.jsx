    ...
    return (
        <div className="max-w-5xl mx-auto pb-12 animate-fade-in space-y-8">
            ...
            <div className="bg-card dark:bg-zinc-900/40 border border-border/50 dark:border-white/5 rounded-3xl shadow-2xl overflow-hidden backdrop-blur-sm relative">
                ...
                {/* Tab Navigation */}
                <div style={{ overflowX: 'auto', WebkitOverflowScrolling: 'touch', scrollbarWidth: 'none', msOverflowStyle: 'none' }} className="flex justify-center border-b border-border/50 dark:border-white/5 bg-muted/20 dark:bg-black/20 [&::-webkit-scrollbar]:hidden">
                    {TABS.map((tab) => {
                                        ...
                                        <div className="space-y-8">
                                            ...
                                            <div className="bg-muted/10 dark:bg-black/60 rounded-3xl p-8 border border-border/50 dark:border-white/5">
                                                {formData.management_type === 'CONSTRUCTION' ? (
                                                    ...
                                                    <div className="grid gap-6">
                                                        <div className="grid gap-3">
                                                            <label className="text-[11px] font-black text-muted-foreground uppercase tracking-widest ml-1">{t('property_detail.details.asking_price')} <span className="text-primary">*</span></label>
                                                            <div className="relative">
